  ...
  return (
    <div className='flex justify-center items-center gap-10 h-[calc(100vh-20vh)] mt-10 sm:px-44 px-10 '>
      <div className='sm:w-[50%]'>
        ...
        <button className='bg-blue-500 mr-5 text-white px-4 py-2 rounded-md'>Shop Now</button>
        <button className='border px-4 py-2 rounded-md text-blue-600 font-semibold'>Explore More</button>
      </div>
